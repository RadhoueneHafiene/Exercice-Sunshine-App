...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL locationUrl = NetworkUtils.buildUrl(searchUrl);
            String SearchResult = null;
            String[] weatherSearchResults = null;
            try {
                SearchResult = NetworkUtils.getResponseFromHttpUrl(locationUrl);
                weatherSearchResults = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, SearchResult);
        ...
        protected void onPostExecute(String[] weatherSearchResults) {
            if (weatherSearchResults != null) {
                for (String weatheresult : weatherSearchResults) {
                    mWeatherTextView.append((weatheresult) + "\n\n\n");
                }
            }
        }
    }
